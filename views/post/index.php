...
<section class="bg-text-area">
        ...
        <section class="blog-post-area">
                    ...
                    <div class="blog-post-area-style">
                            ...
                            <div class="col-md-3">
                                <div class="single-post">
                                    <?=  Html::img($country->img,['style'=>['width'=>'120px', 'height'=>'80px' ],'class'=>'img-responsive']) ?>
                                    <h3><a href="<?= Url::to(['post/view', 'id' => $country->id]) ?>"><?= $country->name ?></a></h3>
                                    <h4><span>Code: <span class="author-name"><?= $country->code ?></span></span>
                                    </h4>
                                    <h4><span>Population: <span class="author-name"><?= $country->population ?></span></span>
                                    <h4><span><?= Yii::$app->formatter->asDate($country->created_at) ?></span></h4>
                                </div>
                            </div>
                            <?php endforeach ?>
                    </div>
            ...
            <div class="pegination" style="display:flex ; justify-content:center">
                <?= LinkPager::widget([
                    'pagination' => $pages
                ]) ?>;
                <!-- <div class="nav-links">
